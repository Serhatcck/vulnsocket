...
<body>
    ...
    <script>
        wsUri = 'ws://localhost:8586?token=<?=$token?>';
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">This is a secure WebSocket.</p>
                Start Server: <pre>python3 socket_servers/socket_cswsh_secure.py </pre>
            </div>
        </section>
